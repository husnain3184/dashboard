            ...
            <div className="col-lg-8 col-md-6 mb-md-0 mb-4">
                        <div className="card">
                            ...
                            <div className="table-responsive">
                                ...
                                <tbody>
                                   {
                                       ProductListjson.map((items,key)=>{
                                           return(
                                            <tr id={key} key={key}>
                                        <td>
                                            <div className="d-flex px-2 py-1">
                                            <div>
                                                <img src={items.avatar} className="avatar avatar-sm me-3" alt="xd"/>
                                            </div>
                                            <div className="d-flex flex-column justify-content-center">
                                                <h6 className="mb-0 text-sm">{items.Companies}</h6>
                                            </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td className="align-middle text-center text-sm">
                                            <span className="text-xs font-weight-bold">{items.Budeget}</span>
                                        </td>
                                        <td className="align-middle">
                                            <div className="progress-wrapper w-75 mx-auto">
                                            <div className="progress-info">
                                                <div className="progress-percentage">
                                                <span className="text-xs font-weight-bold">{items.progresspercentage}</span>
                                                </div>
                                            </div>
                                            <div className="progress">
                                                <div className={`progress-bar ${items.iconscolor}`} role="progressbar" aria-valuenow={items.ariavaluenow} aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                            </div>
                                        </td>
                                    </tr>
